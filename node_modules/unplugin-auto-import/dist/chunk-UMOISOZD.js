...
var _chunkRIWX7NTAjs = require('./chunk-RIWX7NTA.js');
...
function resolveOptions(options = {}, root = process.cwd()) {
  ...
  const resolved = _chunkRIWX7NTAjs.__spreadProps.call(void 0, _chunkRIWX7NTAjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkRIWX7NTAjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkRIWX7NTAjs.presets[definition];
