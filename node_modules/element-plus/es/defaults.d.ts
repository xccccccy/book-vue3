declare const _default: {
    ...
    install: (app: import("vue").App<any>, options?: Partial<import("vue").ExtractPropTypes<{
        ...
        readonly experimentalFeatures: import("./utils").BuildPropReturn<import("./utils").PropWrapper<import("./tokens").ExperimentalFeatures>, unknown, unknown, unknown, unknown>;
