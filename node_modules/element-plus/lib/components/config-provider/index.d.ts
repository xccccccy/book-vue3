export declare const ElConfigProvider: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly size: import("element-plus/es/utils").BuildPropReturn<StringConstructor, unknown, unknown, "" | "small" | "large", unknown>;
    ...
    size: import("element-plus/es/utils").BuildPropType<StringConstructor, "" | "small" | "large", unknown>;
