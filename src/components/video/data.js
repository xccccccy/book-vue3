...
const DATA = [{
  id: 'gdbzhhifhh',
  title: '5 Centimeters per Second 5 Centimeters per Second 5 Centimeters per Second 5 Centimeters per Second 5 Centimeters per Second 5 Centimeters per Second ',
