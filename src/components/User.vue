<template>
  <div class="user-all" :class="{ headeractivate: loginShow }" style="margin-right: .6rem">
    <svg @click="loginShow = !loginShow" viewBox="0 0 1024 1024">
      ...
      <path
        d="M512.9216 920.1664c-225.0752 0-408.1664-183.0912-408.1664-408.1664s183.0912-408.1664 408.1664-408.1664S921.088 286.9248 921.088 512s-183.0912 408.1664-408.1664 408.1664z m0-754.8928c-191.1808 0-346.7264 155.5456-346.7264 346.7264s155.5456 346.7264 346.7264 346.7264S859.648 703.1808 859.648 512s-155.4944-346.7264-346.7264-346.7264z"
        class="fill-current" p-id="21197" />
      <path
